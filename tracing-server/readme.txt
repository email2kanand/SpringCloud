...
_____________Enable Kafka and Queue_______________________________
...
But if we store directly to ES that might be not able to consume if high thruhput.
and also can scale like kafka.In realtime we might be having n no of microservices to store trace details.
